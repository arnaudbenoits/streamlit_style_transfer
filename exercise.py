...
# 1.1. Put a title at the top of your page "Neural Style Transfer"



# 1.2. Put a title at the top of your sidebar "Navigation"



# 1.3. Put a header at the top of your page "Options"



# 1.4. Run your application for the first time (in your terminal)
...
#        Store it in a variable : content_file



# 2.2.1. Else let the user choose between all the
#        content images name and save its value in a variable : content_name
#        eventually get the content file from the "content_images_dict"
